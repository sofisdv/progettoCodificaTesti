    ...
    <xsl:template match="/">
        ...
        <html>
            <head>
                ...
                <title>Codifica di Testi - pp 58,59,60 - Sofia Di Viesti</title>
            </head>
            ...
            <body>
                ...
                <div class="header">
                    ...
                    <h5><xsl:value-of select="tei:TEI/tei:teiHeader/tei:fileDesc/tei:notesStmt/tei:note"/></h5>
                </div>

                <div class="sezione1">
                    <h1>Analisi della fonte</h1>
                ...
                <div class="sezione2">
                    ...
                    <h1>Scelte editoriali</h1>
                    <p>
                        <xsl:value-of select="tei:TEI/tei:teiHeader/tei:encodingDesc/tei:editorialDecl/tei:correction"/>
                        <br/><br/>
                        <xsl:value-of select="tei:TEI/tei:teiHeader/tei:encodingDesc/tei:editorialDecl/tei:quotation"/>
                        <br/><br/>
                        <xsl:value-of select="tei:TEI/tei:teiHeader/tei:encodingDesc/tei:editorialDecl/tei:hyphenation"/>
                        <br/><br/>
                        <xsl:value-of select="tei:TEI/tei:teiHeader/tei:encodingDesc/tei:editorialDecl/tei:interpretation"/>
                    </p>
                ...
                <footer>
                    <p>Pagina web realizzata usando la trasformazione XSLT della codifica XML TEI delle pagine 58-60 del diario di Emanuele Artom.</p>
                    <p>Vedi su <a target="_blank" href="https://github.com/sofisdv/progettoCodificaTesti/tree/main">GitHub</a>.</p>
                    <br/>
                    <p>di Sofia Di Viesti, gennaio-febbraio 2024</p>
                </footer>
